...
public class SwaggerConfig {
	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("SGE - Sistema de Gerenciamento Escolar").version("1.0.0")
						.description("Faculdade Senac Pernambuco - Projeto Integrador III")
						.contact(new Contact().name("Rafael Vitor de Oliveira")
								.url("https://www.linkedin.com/in/rafaelvitor2/").email("rafaelvd2@hotmail.com")))
